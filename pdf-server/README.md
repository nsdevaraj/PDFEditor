...
node dist/index.js ./docs/paper.pdf /path/to/thesis.pdf

# Load from URLs
node dist/index.js https://arxiv.org/pdf/2401.00001.pdf

# Mix local and remote
node dist/index.js ./local.pdf https://arxiv.org/pdf/2401.00001.pdf

# stdio mode for MCP clients
node dist/index.js --stdio ./papers/
```
